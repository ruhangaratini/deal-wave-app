...
const double _kCardMaxWidth = 300;
        ...
        Align(
          ...
          child: GridView(
            ...
            gridDelegate: SliverGridDelegateWithMaxCrossAxisExtent(
              ...
              crossAxisSpacing: 10,
              maxCrossAxisExtent: _kCardMaxWidth,
            ),
            children: [
              BaseCard(
                ...
                child: Column(
                  children: [
                    Align(
                      alignment: Alignment.topLeft,
                      child: Text('Atualizações', style: theme.text.bodyLarge),
                    ),
                  ],
                ),
              ),
              ...
              BaseCard(
                ...
                child: Column(
                  children: [
                    Align(
                      alignment: Alignment.topLeft,
                      child: Text('Retorno Total', style: theme.text.bodyLarge),
                    ),
                    const SizedBox(height: 20),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
              ...
              child: BaseCard(
                ...
                child: Column(
                  children: [
                    Align(
                      alignment: Alignment.topLeft,
                      child: Text('Transações', style: theme.text.bodyLarge),
                    ),
                    const SizedBox(height: 20),
                  ...
                  BaseCard(
                    ...
                    child: Column(
                      children: [
                        Align(
                          alignment: Alignment.topLeft,
                          child: Text('Receita', style: theme.text.bodyLarge),
                        ),
                        const SizedBox(height: 40),
                        AspectRatio(aspectRatio: 2, child: RevenueChart()),
                      ],
                    ),
                  ),
                  BaseCard(
                    ...
                    child: Column(
                      children: [
                        Align(
                          alignment: Alignment.topLeft,
                          child: Text('Vendas', style: theme.text.bodyLarge),
                        ),
                        const SizedBox(height: 40),
